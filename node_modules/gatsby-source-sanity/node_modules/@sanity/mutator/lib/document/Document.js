...
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } // Models a document as it is changed by our own local patches and remote patches coming in from
...
class Document {
  ...
  consumeUnresolved(txnId) {
    ...
    (0, _debug.default)('The mutation was not the upcoming mutation, scrubbing. Pending: %d, Submitted: %d', this.pending.length, this.submitted.length);
    ...
    (0, _debug.default)("After scrubbing: Pending: %d, Submitted: %d", this.pending.length, this.submitted.length);
  ...
  rebase(incomingMutations) {
    ...
    this.EDGE = _Mutation.default.applyAll(this.HEAD, this.submitted.concat(this.pending));
