...
function _toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } // A wrapper for Document that allows the client to gather mutations on the client side and commit them
// when it wants to.
...
class BufferedDocument {
  ...
  commit() {
    return new Promise((resolve, reject) => {
      ...
      (0, _debug.default)('Committing local changes');
  ...
  _cycleCommitter() {
    ...
    var responder = {
      ...
      failure: () => {
        (0, _debug.default)('Commit failed');
        // Re stage commit
        commit.tries += 1;
        if (this.LOCAL !== null) {
  ...
  handleDocumentDeleted() {
    (0, _debug.default)('Document deleted');
  ...
  handleDocMutation(msg) {
    ...
    (0, _debug.default)('Document mutated from remote with local changes');
