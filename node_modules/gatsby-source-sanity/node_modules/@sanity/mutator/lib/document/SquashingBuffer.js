...
class SquashingBuffer {
  ...
  addOperation(op) {
    ...
    (0, _debug.default)('Unoptimizable mutation detected, purging optimization buffer');
  ...
  optimiseSetOperation(path, nextValue) {
    ...
    // we won't optimise
    var matches = (0, _extractWithPath.default)(path, this.PRESTAGE);
    ...
    var canonicalPath = (0, _arrayToJSONMatchPath.default)(match.path);
