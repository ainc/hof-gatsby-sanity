...
var fs_1 = require("fs");
var mapCrossDatasetReferences_1 = require("./util/mapCrossDatasetReferences");
...
var initializePlugin = function (_a, pluginOptions) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var config, unsupportedVersionMessage, api, client, graphqlSdl, graphqlSdlKey, typeMap, typeMapKey, err_1, prefix;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 6, , 7]);
                    api = '';
                    if (!config._mocks) return [3 /*break*/, 2];
                    reporter.warn('[sanity] Using mocked GraphQL schema');
                    api = (0, fs_1.readFileSync)(config._mocks.schemaPath, 'utf8');
                    return [3 /*break*/, 4];
                case 2:
                ...
                case 3:
                    ...
                    _b.label = 4;
                case 4:
                    api = (0, mapCrossDatasetReferences_1.mapCrossDatasetReferences)(api);
                ...
                case 5:
                    ...
                    typeMap = (0, remoteGraphQLSchema_1.getTypeMapFromGraphQLSchema)(api, config.typePrefix);
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, args.cache.get((0, cache_1.getCacheKey)(config, cache_1.CACHE_KEYS.LAST_BUILD))];
            case 1:
                lastBuildTime = _c.sent();
                deltaHandled = false;
                if (!lastBuildTime) return [3 /*break*/, 6];
                _c.label = 2;
            case 2:
                _c.trys.push([2, 5, , 6]);
                _a = Set.bind;
            ...
            case 6:
                ...
                if (!!deltaHandled) return [3 /*break*/, 8];
            ...
            return [4 /*yield*/, args.cache.set((0, cache_1.getCacheKey)(config, cache_1.CACHE_KEYS.LAST_BUILD), new Date().toISOString())];
            case 9:
                // register the current build time for accessing it in handleDeltaChanges for future builds
                _c.sent();
                return [2 /*return*/];
...
function getClient(config) {
    var projectId = config.projectId, dataset = config.dataset, _a = config.apiHost, apiHost = _a === void 0 ? 'https://api.sanity.io' : _a, token = config.token;
