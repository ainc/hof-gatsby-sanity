...
function getTypeMapFromGraphQLSchema(sdl, typePrefix) {
    ...
    typeMap.objects = groups.ObjectTypeDefinition.reduce(function (acc, typeDef) {
        ...
        var name = (0, normalize_1.getTypeName)(typeDef.name.value, typePrefix);
        acc[name] = {
            name: name,
            kind: 'Object',
    ...
    typeMap.unions = groups.UnionTypeDefinition.reduce(function (acc, typeDef) {
        ...
        acc[name] = {
            name: name,
            types: (typeDef.types || []).map(function (type) { return (0, normalize_1.getTypeName)(type.name.value, typePrefix); }),
        };
        return acc;
    }, unions);
    return typeMap;
