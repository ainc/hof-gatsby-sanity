...
function getSyncWithGatsby(props) {
    ...
    var typeMap = processingOptions.typeMap, overlayDrafts = processingOptions.overlayDrafts, typePrefix = processingOptions.typePrefix;
    ...
    return function (id, updatedDocument) {
        ...
        if (doc) {
            var type = (0, normalize_1.getTypeName)(doc._type, typePrefix);
