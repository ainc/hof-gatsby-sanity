...
const Footer = () => {
  ...
  const sponsorOpportunites =
    query.allSanityDocuments.nodes.at(-1).sponsorOpportunites;
          ...
          <Col className="mx-lg-4" md={7}>
            <Row>
              <Col>
                ...
                <p className="mb-0">
                  Click{" "}
                  <a href={sponsorOpportunites.asset.url} target="_blank">
                    Here
                  </a>{" "}
                  to Review Sponsorship Opportunities & Benefits
                </p>
                <p className="mb-0">
                  Click{" "}
                  <a href={footerInfo.sponsorLink} target="_blank">
                    Here
                  </a>{" "}
                  to register online as a sponsor
                </p>
                <p>
                  Contact {footerInfo.sponsorContact.name} at{" "}
                  <a href={`mailto:${footerInfo.sponsorContact.email}`}>
                    {footerInfo.sponsorContact.email}
                  </a>{" "}
                  or{" "}
                  <a href={`tel:${footerInfo.sponsorContact.phoneNumber}`}>
                    {footerInfo.sponsorContact.phoneNumber}
                  </a>
                </p>
              </Col>
            </Row>
            <Row>
              <Col>
                ...
                <p>
                  Click{" "}
                  <a href={advertisingDoc.asset.url} target="_blank">
                    Here
                  </a>{" "}
            ...
            <Row>
              <Col>
                ...
                <p>
                  <a href="/nominate">
                    Nominate for the Hall of Fame, Emerging Entreprenuer, and
                    others.
                  </a>
                </p>
              </Col>
          ...
          <Col className="mx-lg-4">
            <Row>
              <Col>
                ...
                <p>
                  <a href="mailto:ky@entrepreneurhof.com" target="_blank">
                    ky@entrepreneurhof.com
                  </a>
                </p>
                <p>
                  <a href="https://twitter.com/entrepreneurhof" target="_blank">
                    Follow @entrepreneurhof
                  </a>
                </p>
              </Col>
            </Row>
