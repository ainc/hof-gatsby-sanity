      ...
      <Container>
        ...
        <div className={styles.aboutAuthor}>
          ...
          <Body><ul><li>
              ...
              <li>
              <a  href='https://www.instagram.com/p/BtzIZFAh6Ow/?utm_source=ig_web_button_share_sheet' target='_blank'>Lee Todd</a>
              </li>
              <li>
              <a  href='https://www.instagram.com/p/BuEqiFYBh-o/?utm_source=ig_web_button_share_sheet' target='_blank'>Jim Host</a>
              </li>
              </ul></Body>  
            <Body>Pick up a copy of the audio book here:</Body>
            <Body><ul><li>
              <a  href='http://amzn.to/2yrO97K' target='_blank'>Unbridled Spirit on Amazon</a>
              </li>
              <li>
              <a  href='https://adbl.co/2zJeaxo' target='_blank'>Unbridled Spirit on Audible (Sign in with your Amazon account too!)</a>
              </li>
              <li>
