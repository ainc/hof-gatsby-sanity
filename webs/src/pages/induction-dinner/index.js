          ...
          <Container>
            ...
            <Row>
              <Col className='mx-4 py-3'>
                ...
                <h3 className={styles.bodyText}>Student Ticket<span style={{ marginLeft: '17px' }} >${event.dinnerPrice.studentTicket}</span></h3>
...
export const Head = () => <title>Induction Dinner | Kentucky Entrepreneur Hall of Fame</title>;