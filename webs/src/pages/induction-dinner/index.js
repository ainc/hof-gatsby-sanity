      ...
      <Container>
        ...
        <Row>
          <Col className="mx-4 py-3">
            <h2 className={styles.induction}>
              About the Induction Celebration
            </h2>
            <h3 className={styles.bodyText}>
              Join us as we induct this year’s class of entrepreneurs. The
              Kentucky Entrepreneur Hall of Fame shares and celebrates the
              stories of Kentucky's most successful entrepreneurs. Our mission
              is to raise awareness of the impact that entrepreneurship has made
              in the Commonwealth and encourage others to pursue similar
              ambitious endeavors.
            </h3>
        ...
        <Row>
          <Col className="mx-4 py-3">
            ...
            <h3 className={styles.bodyText}>
              {renderScheduleWithBreaks(event.schedule)}
            </h3>
          </Col>
        </Row>
        <Row>
          <Col className="mx-4 py-3">
            ...
            <h3 className={styles.bodyText}>
              ...
              <span style={{ marginLeft: "90px" }}>
                ${event.dinnerPrice.regularTicket}
              </span>
            </h3>
            <h3 className={styles.bodyText}>
              Student Ticket
              <span style={{ marginLeft: "17px" }}>
                ${event.dinnerPrice.studentTicket}
              </span>
            </h3>
            <h3 className={styles.bodyText}>
              Table of Ten
            ...
            <h6 className={styles.bodyText}>
              ...
              prior to the event to receive a refund. After this date, no cash
              refunds will be granted. Substitutions are welcome. Special
        ...
        <Row>
          <Col className="mx-4 py-3">
            ...
            <h3 className={styles.bodyText}>
              ...
              <br />
              {event.location.city}, KY {event.location.zip}
              <br />
              Phone: {event.location.contact.phoneNumber}
            </h3>
            <a className={styles.linkText} href={event.location.link}>
              Directions/Parking
            </a>
            ...
            <h3 className={styles.bodyText}>
              ...
              <br />
              {event.hotelInfo.location.address}
              <br />
              {event.hotelInfo.location.city}, KY {event.hotelInfo.location.zip}
              <br />
              Phone: {event.hotelInfo.location.contact.phoneNumber}
              <br />
        ...
        <Row>
          <Col className="mx-4 py-3">
            ...
            <h3 className={styles.bodyText}>
              This event offers unique sponsorship opportunities. Our options
              cater to market needs and fit a range of budgets. We're here to
              help you make valuable connections and create measurable results.
            </h3>
            <a
